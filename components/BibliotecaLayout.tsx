...
export function BibliotecaLayout({ semesters, semesterDetails }: BibliotecaLayoutProps) {
  ...
  return (
    <main className="min-h-screen" style={{ background: 'linear-gradient(180deg, #fdf8f3 0%, #faf3eb 50%, #fdf8f3 100%)' }}>
      ...
      {/* WhatsApp Floating Button — solo ícono, diseño profesional */}
      <motion.a
        href="https://wa.me/59178921992"
        target="_blank"
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-2xl transition-shadow duration-300 hover:shadow-[0_8px_30px_-6px_rgba(37,211,102,0.45)]"
        style={{
          background: 'linear-gradient(145deg, #25D366 0%, #1DA851 100%)',
          boxShadow:
            '0 6px 20px -8px rgba(37,211,102,0.35), 0 2px 8px -4px rgba(0,0,0,0.08)',
        }}
      >
        {/* Icono de WhatsApp (vector blanco) */}
        <svg
          viewBox="0 0 24 24"
          fill="none"
